        ...
        for r in range(2):
            try:
                ...
                #     window_col.append(ppg_window)
                    ...
                    # plt.vlines(cpnt,-2,2,label='Location of Detected Change points',linewidth=3,color='black')
                    # ax = plt.gca()
                    # # # ax.set_title('oh no')
                    # rect_col = []
                    # count = 1
                    ...
                    #         rect = pat.Rectangle((a[0],-2),a[1]-a[0],4,facecolor='y',alpha=.4,label='Annotated Segment '+str(count))
                    #         count+=1
                    ...
                    # plt.yticks([])
                    # plt.legend(loc='best')
                    # plt.savefig('./images1/'+str(t)+'.pdf',dps=2000)
                    # plt.close('all')
                    # plt.show()
